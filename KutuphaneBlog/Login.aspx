<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="KutuphaneBlog.Login" %>
...
<html lang="en">
<head>
    <title>Gemlik Kitabevim Blog </title>
    <!-- Meta tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="keywords" content="Gaze Sign up & login Form Responsive Widget, Audio and Video players, Login Form Web Template, Flat Pricing Tables, Flat Drop-Downs, Sign-Up Web Templates, Flat Web Templates, Login Sign-up Responsive Web Template, Smartphone Compatible Web Template, Free Web Designs for Nokia, Samsung, LG, Sony Ericsson, Motorola Web Design" />
    <link rel="icon" href="web/images/stack-of-books.png" type="image/jpeg">
    <script>
...
<body>
    <div class="mid-class">
        ...
        <div class="art-left-w3ls">
            <h1 class="header-w3ls">Gemlik Kitabevim Giriş Paneli 
            </h1>
        </div>
    </div>
    <footer class="bottem-wthree-footer">
        <p>
            © 2024 Tüm Hakları Saklıdır. Gemlik Kitabevim | Design by
